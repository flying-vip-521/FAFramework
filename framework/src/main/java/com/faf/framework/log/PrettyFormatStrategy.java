...
public class PrettyFormatStrategy implements FormatStrategy {
    ...
    @Nullable
    private String tag;
    private boolean printStackOnlyException = true;
    ...
    private PrettyFormatStrategy(@NonNull Builder builder) {
        ...
        printStackOnlyException = builder.printStackOnlyException;
        tag = builder.tag;
    }
    ...
    public void log(int priority, @Nullable String onceOnlyTag, @NonNull String message) {
        ...
        if (length <= CHUNK_SIZE) {
            if (showStack(priority) && methodCount > 0) {
    ...
    private boolean showStack(int priority) {
        if (printStackOnlyException) {
            return priority == L.ERROR || priority == L.WARN;
        }
        return true;
    ...
    public static class Builder {
        boolean printStackOnlyException = true;
        int methodCount = 10;
        int methodOffset = 0;
        ...
        public Builder onlyPrintStackOnException(boolean printStackOnlyException) {
            this.printStackOnlyException = printStackOnlyException;
            return this;
        }
//
