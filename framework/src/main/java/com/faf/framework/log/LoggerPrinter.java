...
import static com.faf.framework.log.L.*;
...
class LoggerPrinter implements Printer {
    ...
    public boolean needAddDefaultLogAdapter() {
        return logAdapters.isEmpty();
    }
    ...
    @NonNull
    protected String createMessage(@NonNull String message, @Nullable Object... args) {
